...
const categoryMuscleMap: Record<string, { primary: MuscleId[]; secondary: MuscleId[] }> = {
...
const ALL_MUSCLES_PRIMARY: MuscleId[] = ['chest', 'abs', 'quadriceps', 'biceps', 'front-deltoid', 'obliques'];
const ALL_MUSCLES_SECONDARY: MuscleId[] = ['triceps', 'forearms-front', 'lats', 'trapezius-back', 'glutes', 'hamstrings', 'calves', 'lower-back', 'rear-deltoid'];
...
export default function ExercisesScreen() {
  ...
  const getActiveHighlightMuscles = () => {
    ...
    if (selectedCategory === 'All') {
      return { primary: ALL_MUSCLES_PRIMARY, secondary: ALL_MUSCLES_SECONDARY };
    }
    const catMap = categoryMuscleMap[selectedCategory];
    if (catMap) {
      return catMap;
    }
          ...
          <View style={styles.muscleScannerContainer}>
            ...
            <View style={styles.legendContainer}>
              ...
              <View style={styles.legendItem}>
                <View style={[styles.legendDot, { backgroundColor: MUSCLE_INTENSITY_COLORS.moderate }]} />
                <Text style={styles.legendText}>{t('exercises.legend_primary')}</Text>
              </View>
              <View style={styles.legendItem}>
                <View style={[styles.legendDot, { backgroundColor: MUSCLE_INTENSITY_COLORS.low }]} />
