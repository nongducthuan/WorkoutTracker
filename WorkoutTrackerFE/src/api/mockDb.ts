...
const DEFAULT_EXERCISES: Exercise[] = [
  { id: 1, name: 'Barbell Bench Press', category: 'Chest', difficulty: 'Intermediate', description: 'A classic compound lift targeting the chest, shoulders, and triceps.' },
  { id: 2, name: 'Incline Dumbbell Press', category: 'Chest', difficulty: 'Intermediate', description: 'An upper-chest focused pressing movement using dumbbells.' },
  { id: 3, name: 'Cable Chest Fly', category: 'Chest', difficulty: 'Beginner', description: 'An isolation movement targeting the chest muscles with constant cable tension.' },
  { id: 4, name: 'Barbell Back Squat', category: 'Legs', difficulty: 'Intermediate', description: 'A fundamental lower body exercise targeting the quadriceps and glutes.' },
  { id: 5, name: 'Leg Press', category: 'Legs', difficulty: 'Beginner', description: 'A machine-based lower body press focusing primarily on the quadriceps.' },
  { id: 6, name: 'Leg Extensions', category: 'Legs', difficulty: 'Beginner', description: 'An isolation exercise targeting the quadriceps on a machine.' },
  { id: 7, name: 'Conventional Deadlift', category: 'Back', difficulty: 'Advanced', description: 'A heavy compound movement that works the entire posterior chain.' },
  { id: 8, name: 'Lat Pulldown', category: 'Back', difficulty: 'Beginner', description: 'A vertical pulling exercise targeting the latissimus dorsi.' },
  { id: 9, name: 'Barbell Row', category: 'Back', difficulty: 'Intermediate', description: 'A horizontal pulling movement targeting the upper and mid back.' },
  { id: 10, name: 'Overhead Press', category: 'Shoulders', difficulty: 'Intermediate', description: 'A vertical press targeting the shoulders and upper chest.' },
  { id: 11, name: 'Dumbbell Lateral Raise', category: 'Shoulders', difficulty: 'Beginner', description: 'An isolation exercise targeting the lateral deltoids.' },
  { id: 12, name: 'Barbell Bicep Curl', category: 'Arms', difficulty: 'Beginner', description: 'An isolation movement targeting the biceps.' },
  { id: 13, name: 'Tricep Rope Pushdown', category: 'Arms', difficulty: 'Beginner', description: 'An isolation exercise targeting the lateral and medial heads of the triceps.' },
  { id: 14, name: 'Incline Bench Skull Crushers', category: 'Arms', difficulty: 'Intermediate', description: 'An overhead tricep extension targeting the long head of the triceps.' },
  { id: 15, name: 'Hanging Leg Raise', category: 'Core', difficulty: 'Advanced', description: 'An advanced core exercise targeting the lower abdominals.' },
  { id: 16, name: 'Plank', category: 'Core', difficulty: 'Beginner', description: 'An isometric core exercise targeting the deep abdominal muscles.' },
  { id: 17, name: 'Assault Bike Interval', category: 'Cardio', difficulty: 'Intermediate', description: 'High-intensity interval cardiovascular training using an air resistance bike.' },
  { id: 18, name: 'Treadmill Run', category: 'Cardio', difficulty: 'Beginner', description: 'Steady-state or interval running on a treadmill.' },
];
